  ...
  render() {
    ...
    return (
      <div className="note-add flex column" style={this.state.note.style}>
        ...
        />
        {isExpanded && note.type == 'note-todos' && new Array(extraInputsCount).fill(0).map((val, idx) => (
        ...
        {isExpanded && <NoteToolbar note={note} type="new-note" onUpdateType={this.onUpdateType} onPinNote={this.onPinNote} onChangeColor={this.onChangeColor} />}
        {isExpanded && (
