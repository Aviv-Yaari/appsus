...
export class NoteEdit extends React.Component {
    ...
    onUpdateType = (type) => {
        this.setState(prevState => ({ note: { ...prevState.note, type, info: { ...prevState.note.info, txt: '', url: '' } } }))
        ...
        return (
            <React.Fragment>
                ...
                <div className="note-add note-edit flex column" style={this.state.note.style}>
                    <input type="text" name="title" placeholder="Title" value={note.info.title} onChange={this.handleChange} />
                    <input
                    ...
                    />
                    {note.type == 'note-todos' && new Array(extraInputsCount).fill(0).map((val, idx) => (
                    ...
                    {note.type === 'note-todos' && <img src="assets/svg/add-todo.svg" className="add-todo-img" onClick={this.onAddTodo} />}
                    <NoteToolbar note={note} type="new-note" onUpdateType={this.onUpdateType} onPinNote={this.onPinNote} onChangeColor={this.onChangeColor} />
